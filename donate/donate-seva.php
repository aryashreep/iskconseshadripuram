    ...
    <div class="donate-detail-layout cart-layout">
      ...
      <div class="donate-detail-info">
        ...
        <div style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow-sm);margin-bottom:var(--space-lg);">
          <img src="<?php echo $causeImage; ?>" alt="<?php echo htmlspecialchars($causeName); ?>" style="width:100%;height:auto;max-height:400px;object-fit:cover;display:block;">
        </div>
        <?php endif; ?>
        <div class="section-divider" style="justify-content: flex-start;">
          <span class="divider-icon"><i class="fas <?php echo $causeIcon; ?>"></i></span>
        </div>
        <span class="section-subtitle reveal" style="text-align: left;"><?php echo htmlspecialchars($causeShortDesc); ?></span>
        ...
        <div class="seva-offerings-grid-wrap reveal" style="margin-top: var(--space-xl); margin-bottom: var(--space-2xl);">
          <h4 style="font-family: var(--font-heading); margin-bottom: var(--space-md); color: var(--text-dark); border-bottom: 2px solid var(--primary); padding-bottom: var(--space-xs); display: inline-block;">Select Your Seva</h4>
          ...
          <form id="donationForm" autocomplete="on">
            ...
            <div class="form-fields">
              ...
              <div class="form-group">
                ...
                <textarea id="occasion" name="occasion" rows="2" maxlength="100" placeholder="e.g. Birthday blessings, Good health (max 100 chars)" style="width: 100%; padding: 10px 14px; border: 2px solid var(--border); border-radius: var(--radius-md); font-family: var(--font-body); font-size: var(--font-size-sm); color: var(--text); outline: none; background: var(--cream-light); resize: vertical;"></textarea>
              </div>
              ...
              <?php if ($selectedMode === 'monthly'): ?>
              <div class="donate-monthly-notice" id="monthlyNotice">
                <i class="fas fa-info-circle"></i> You will be charged <span id="monthlyAmountDisplay"><?php echo CURRENCY_SYMBOL . number_format($defaultAmount); ?></span> on the same day each month.
              </div>
              <?php endif; ?>
...
<section class="related-causes-section">
  <div class="container">
    ...
    <span class="section-subtitle reveal" style="text-align:center;">Explore More</span>
    <h2 class="section-title reveal" style="text-align:center;">Related Seva Opportunities</h2>
...
<script src="<?php echo BASE_URL; ?>assets/js/donate.js?v=1.1.4"></script>
