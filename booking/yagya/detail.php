...
<section class="page-content">
  <div class="container">
    ...
    <div class="reveal" style="background:var(--cream);border:1px solid var(--border);border-radius:var(--radius-lg);padding:var(--space-md) var(--space-xl);display:inline-flex;align-items:center;gap:15px;margin-bottom:var(--space-xl);">
      <span style="font-size:24px;color:var(--primary);">🔥</span>
      <div>
        <span style="display:block;font-size:11px;text-transform:uppercase;color:var(--text-light);font-weight:600;letter-spacing:1px;">Yagya Date &amp; Timing</span>
        <strong style="color:var(--text-dark);font-size:var(--font-size-md);"><?php echo $yagya['date']; ?> &amp; <?php echo $yagya['time']; ?></strong>
      </div>
    </div>

    <!-- Main Banner Image -->
    <div class="reveal" style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow-sm);margin-bottom:var(--space-2xl);">
      <img src="<?php echo BASE_URL . $yagya['image']; ?>" alt="<?php echo htmlspecialchars($yagya['name']); ?>" style="width:100%;height:auto;max-height:450px;object-fit:cover;display:block;">
    </div>

    <!-- Description & Badges Grid -->
    <div style="display:grid;grid-template-columns:1.5fr 1fr;gap:var(--space-2xl);align-items:start;margin-bottom:var(--space-3xl);" class="booking-grid">

      <!-- Left: Description -->
      <div class="reveal">
        <h2 style="font-family:var(--font-heading);color:var(--text-dark);margin-top:0;margin-bottom:var(--space-md);"><?php echo htmlspecialchars($yagya['subtitle']); ?></h2>
        <p style="color:var(--text-light);font-size:var(--font-size-sm);line-height:1.8;margin:0;">
    ...
    <div style="margin-bottom:var(--space-3xl);">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));gap:var(--space-xl);" class="tier-grid">
        <?php foreach ($sponsoringTiers as $tier): ?>
          <div class="yagya-tier-card reveal">
            <div>
              ...
              <div style="display:flex;flex-wrap:wrap;gap:5px;margin-bottom:var(--space-md);">
            ...
            <div style="border-top:1px dashed var(--border);padding-top:var(--space-md);margin-top:var(--space-md);display:flex;justify-content:space-between;align-items:center;">
    ...
    <div style="display:grid;grid-template-columns:1.2fr 1fr;gap:var(--space-3xl);margin-bottom:var(--space-3xl);" class="booking-grid reveal">
      ...
      <!-- Left: Hymns -->
      <div>
        <h3 style="font-family:var(--font-heading);color:var(--text-dark);margin-bottom:var(--space-lg);border-bottom:2px solid var(--border);padding-bottom:var(--space-xs);">
...
<div id="bookingModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;align-items:center;justify-content:center;padding:var(--space-md);">
  <div style="background:var(--white);width:100%;max-width:550px;border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow-lg);position:relative;animation:modalZoom 0.25s var(--transition-ease);">

    <div style="background:var(--gradient-primary);color:var(--white);padding:var(--space-lg) var(--space-xl);display:flex;justify-content:between;align-items:center;">
      <h4 style="font-family:var(--font-heading);margin:0;font-size:var(--font-size-lg);" id="modalYagyaTitle">Maha Yagya Sankalpa</h4>
      <span style="font-size:24px;cursor:pointer;opacity:0.8;line-height:1;" onclick="closeBookingModal()">&times;</span>
    </div>

    <form id="yagyaBookingModalForm" style="padding:var(--space-xl);">
      ...
      <div class="form-fields">
        ...
        <div style="background:var(--cream);border-radius:var(--radius-md);padding:var(--space-md);display:flex;justify-content:between;align-items:center;margin:var(--space-md) 0;border:1px solid var(--border);">
          ...
          <div style="font-size:var(--font-size-xl);font-family:var(--font-heading);color:var(--primary);font-weight:700;" id="modalAmountLabel">₹0.00</div>
        </div>

        <button type="submit" class="btn btn-primary btn-lg" style="width:100%;justify-content:center;display:flex;align-items:center;gap:10px;" id="bookBtn">
    ...
    <!-- Loading Overlay -->
    <div class="donate-loading" id="bookLoading" style="display:none;position:absolute;inset:0;background:rgba(255,255,255,0.85);z-index:10;flex-direction:column;justify-content:center;align-items:center;">
