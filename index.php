<?php
$pageTitle = 'ISKCON The Palace Temple of Lord Jagannath, Seshadripuram Bangalore';
$metaDescription = 'ISKCON The Palace Temple of Lord Jagannath in Seshadripuram, Bangalore — daily darshan, puja booking, festivals, and spiritual programs since 1998. Visit the official ISKCON temple website.';
$pageType = 'home';
  ...
  <div class="container">
    ...
    <div class="welcome-content">
      ...
      <div class="welcome-text reveal">
        ...
        <a href="about" class="btn btn-primary" style="margin-top:var(--space-lg);"><i class="fas fa-info-circle"></i> Learn More</a>
      </div>
    </div>
  </div>
</section>
...
<section class="section events-section">
  <div class="container">
    ...
    <div class="visit-grid" style="text-align:left;">
      <?php 
      ...
      ?>
      <div class="visit-card reveal" style="text-align:center;">
        <div class="visit-card-icon" style="margin-bottom:var(--space-md);"><i class="fas fa-clock"></i></div>
        <h4><?php echo htmlspecialchars($item['time']); ?></h4>
        <p><strong><?php echo htmlspecialchars($item['activity']); ?></strong></p>
        <p style="font-size:var(--font-size-xs);"><?php echo htmlspecialchars($item['desc']); ?></p>
      </div>
      <?php endforeach; ?>
    </div>
...
<section class="cta-section section-dark">
  <div class="container">
    <div class="section-divider"><span class="divider-icon">💛</span></div>
    <span class="section-subtitle reveal" style="color:var(--accent-light);">Support the Mission</span>
