...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  ...
  <Style ss:ID="Header">
   ...
   <Interior ss:Color="#C86B1F" ss:Pattern="Solid"/>
  </Style>
 </Styles>
 <Worksheet ss:Name="Offline Registrations">
  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <DataValidation>
    ...
    <Type>List</Type>
    <Value>&quot;<?php echo implode(',', array_map(function($val) { return str_replace('"', '""', $val); }, $sadans)); ?>&quot;</Value>
   </DataValidation>
   <DataValidation>
    <Range>R2C8:R101C8</Range>
    <Type>List</Type>
    <Value>&quot;Own Vehicle,<?php echo implode(',', array_map(function($val) { return str_replace('"', '""', $val); }, $pickups)); ?>&quot;</Value>
   </DataValidation>
  </WorksheetOptions>
 </Worksheet>
</Workbook>
...
<div style="display:grid; grid-template-columns: 1.2fr 1fr; gap:var(--space-lg); margin-bottom:var(--space-2xl);">
  
  <!-- Left Chart: Bhakti Sadan Ranking (by Persons) -->
  <div style="background:var(--white); padding:var(--space-xl); border-radius:var(--radius-lg); border:1px solid var(--border); box-shadow:var(--shadow-sm);">
    <h3 style="font-family:var(--font-heading); font-size:16px; color:var(--text-dark); margin-top:0; margin-bottom:var(--space-md);">Bhakti Sadan Ranking (by Persons)</h3>
    <div style="height: 380px; position: relative;">
      <canvas id="bhaktiSadanChart"></canvas>
    </div>
  </div>

  <!-- Right Chart: Top Bus Pickup Locations -->
  <div style="background:var(--white); padding:var(--space-xl); border-radius:var(--radius-lg); border:1px solid var(--border); box-shadow:var(--shadow-sm);">
    <h3 style="font-family:var(--font-heading); font-size:16px; color:var(--text-dark); margin-top:0; margin-bottom:var(--space-md);">Top Bus Pickup Locations</h3>
    <div style="height: 380px; position: relative;">
