...
<?php include_once __DIR__ . '/../includes/asset-helper.php'; ?>
<?php
...
<head>
  ...
  <meta name="google-site-verification" content="hVf-M_zzbLfB4ur2uY5U0IV0gdAiIFO1f6iQcl1NYEE" />
  ...
  <!-- Custom Styles -->
  <link class="cache-buster" rel="stylesheet" href="<?= asset('assets/css/style.css') ?>">
  <link rel="stylesheet" href="<?= asset('assets/css/responsive.css') ?>">
  <link rel="stylesheet" href="<?= asset('modules/Donation/assets/css/donate.css') ?>">

  <!-- Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-BNNQGHE1SD"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'G-BNNQGHE1SD');
  </script>
...
<body>
  ...
  <header class="site-header" id="siteHeader">
    ...
    <div class="top-bar">
      <div class="container">
        <div class="top-bar-left">
          <a href="booking/" class="top-bar-link"><i class="fas fa-hands-praying"></i> Book Puja/Yagya</a>
          <span class="top-bar-sep">|</span>
          <a href="yatra/" class="top-bar-link"><i class="fas fa-route"></i> Yatra</a>
          <span class="top-bar-sep">|</span>
          <a href="sudamaseva" class="top-bar-link"><i class="fas fa-sync-alt"></i> Sudamaseva</a>
        </div>
    ...
    <div class="header-inner container-wide">
      ...
      <div class="official-badge header-badge" title="Official ISKCON Temple — A branch of ISKCON Juhu, Mumbai">
        <i class="fas fa-check-circle"></i>
        <span>ISKCON Official</span>
      </div>
        ...
        <ul class="main-nav-list">
          ...
          <li class="nav-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="sudamaseva"><i class="fas fa-sync-alt" style="margin-right:6px;"></i> Monthly Seva (Sudamaseva)</a></li>
              <li class="nav-dropdown">
      ...
      <div class="mobile-header-actions">
        <a href="checkout/" class="mobile-header-cart" aria-label="View Cart">
          <i class="fas fa-shopping-cart"></i>
          <span class="mobile-cart-badge-header" data-cart-count hidden>0</span>
        </a>
  ...
  <div class="mobile-menu">
    <ul class="mobile-menu-list">
      ...
      <li><a href="search"><i class="fas fa-search" style="margin-right:8px;"></i>Search</a></li>
      <li>
